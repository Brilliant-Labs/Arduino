...
//                                  R   G   B
uint8_t myFavoriteColors[][3] = {{225,   0, 0},   // red
                                 {0,   225,   0},   // green
                                 {0, 0, 225},   // blue
                               };
...
void loop() 
{
  ...
  if (abs(newVector - storedVector) > MOVE_THRESHOLD) {
    ...
    flashRandom(5, 20);  // first number is 'wait' delay, shorter num == shorter twinkle
    flashRandom(10, 40);  // second number is how many neopixels to simultaneously light up
    flashRandom(15, 60);
  }
}
